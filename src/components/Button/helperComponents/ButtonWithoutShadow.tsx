...
const ButtonWithoutShadow = ({
  ...
  if (disabledFlag) {
    buttonClassName = `button noshadow ${variant}-disabled ${size} color-${color}`;
  } else {
    buttonClassName = `button noshadow ${variant} ${size} color-${color}`;
  }
...
export default ButtonWithoutShadow;
